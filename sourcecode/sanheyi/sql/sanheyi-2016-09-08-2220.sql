...
-- ----------------------------
INSERT INTO `t_community` VALUES ('1', '特困社区', null, null, null, null, 'Y', '0', null, null, null, null, null, null, null, null, null, '1');
...
CREATE TABLE `t_order_accept` (
  ...
  KEY `user` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='接受资助表';

-- ----------------------------
-- Records of t_order_accept
-- ----------------------------
INSERT INTO `t_order_accept` VALUES ('1', '1', '1', '1000.0000', '1000.0000', '1462545069', '1', '1', '0', '0', '0');
INSERT INTO `t_order_accept` VALUES ('2', '1', '2', '2000.0000', '1000.0000', '1462545069', '1', '1', '1', '0', '0');
INSERT INTO `t_order_accept` VALUES ('3', '1', '3', '3000.0000', '0.0000', '1462545069', '1', '1', '2', '2', '0');
...
CREATE TABLE `t_order_offer` (
  ...
  KEY `user` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='提供资助表';

-- ----------------------------
-- Records of t_order_offer
-- ----------------------------
INSERT INTO `t_order_offer` VALUES ('1', '1', '1', '1000.0000', '1000.0000', '1462545069', '1', '1', '0', '0', '0', '1462545069', '0', null);
INSERT INTO `t_order_offer` VALUES ('2', '1', '2', '2000.0000', '1000.0000', '1462545099', '1', '1', '1', '0', '0', '0', '0', null);
INSERT INTO `t_order_offer` VALUES ('3', '1', '2', '3000.0000', '0.0000', '1462545199', '1', '1', '2', '0', '0', '0', '0', null);
INSERT INTO `t_order_offer` VALUES ('4', '1', '3', '4000.0000', '0.0000', '1462545299', '1', '1', '0', '1', '0', '0', '0', null);
INSERT INTO `t_order_offer` VALUES ('5', '1', '3', '5000.0000', '0.0000', '1462545399', '1', '1', '2', '2', '2', '0', '0', null);
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', '1', '202cb962ac59075b964b07152d234b70', 'caf1a3dfb505ffed0d024130f58c5cfa', '1', '1', '-1', null, '1473144269', null, 'a', 'b', 'c', 'd', '琐琐碎碎', '非凡方法', 'g', '23423424', 'http://local.sanheyi.com/Uploads/2016/09/08/57d15c10141a1.jpg', 'http://local.sanheyi.com/Uploads/2016/09/08/57d15c13cb79a.jpg', 'http://local.sanheyi.com/Uploads/2016/09/08/57d15c16adf29.jpg', '0', '0', null, null, '1', null, null, null, null, 'Y');
...
INSERT INTO `t_user` VALUES ('4', '4444', 'c81e728d9d4c2f636f067f89cc14862c', '665f644e43731ff9db3d341da5c827e1', '2', '2', '1', null, '1473206305', null, null, null, null, null, null, null, null, null, null, null, null, '0', '0', null, null, '0', null, null, null, null, 'Y');
...
INSERT INTO `t_user` VALUES ('11', '克看看', 'c4ca4238a0b923820dcc509a6f75849b', '28c8edde3d61a0411511d3b1866f0636', '琐碎对方', '12312', '1', null, '1473339544', null, null, null, null, null, null, null, null, null, null, null, null, '0', '0', null, null, '0', null, null, null, null, 'Y');
...
-- ----------------------------
INSERT INTO `t_user_currency` VALUES ('1', '1', '1', '3.0000', '0.0000');
INSERT INTO `t_user_currency` VALUES ('2', '1', '2', '100.0000', '0.0000');
INSERT INTO `t_user_currency` VALUES ('3', '1', '3', '200.0000', '0.0000');
INSERT INTO `t_user_currency` VALUES ('4', '1', '4', '300.0000', '0.0000');
INSERT INTO `t_user_currency` VALUES ('5', '1', '5', '1000.0000', '0.0000');
...
CREATE TABLE `t_user_currency_detail` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='会员货币发生变化的明细表';
