...
<div class="beijing"><!--此处可以用行间样式加背景图-->
    ...
    <div class="you">
        <ul class="yi">
            ...
            <li><a href="huiyuanzhuce.html">会员注册</a></li>
        </ul>
        <br />
        <ul class="er">
            <li>年龄区间16-70岁之间</li>
        ...
        <ul class="san">
            ...
            <li><input class="kuang" type="text" placeholder="6-16位之间，注册后不能修改" /></li>
        </ul>
        <ul class="san">
            <li style="text-align:right;">登录密码：</li>
            <li><input class="kuang" type="password" placeholder="登录密码，6-16位之间" /></li>
        </ul>
        <ul class="san">
            <li style="text-align:right;">确认密码：</li>
            <li><input class="kuang" type="password" placeholder="确认密码和登录密码一致" /></li>
        </ul>
        <ul class="san">
            <li style="text-align:right;">姓名：</li>
            <li><input class="kuang" type="text" placeholder="身份证上的姓名"  /></li>
        </ul>
        <ul class="san">
            <li style="text-align:right;">手机号码：</li>
            <li><input class="kuang" type="text" placeholder="手机号码"  /></li>
        </ul>
        <ul class="san">
            <li style="text-align:right;">推荐人帐号：</li>
            <li><input class="kuang" type="text" placeholder="推荐人的登录帐号"  /></li>
        </ul>
        <ul class="san">
