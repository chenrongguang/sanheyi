...
<head>
    ...
    <style type="text/css">
		.beijing{width:1000px; margin:0 auto; position:relative; z-index:0;}
            ...
            .denglu{width:500px; height:260px; position:absolute;top:350px; left: 50%;margin:0 auto;margin-left:-250px;background-color:#fff; border:1px solid #c2c2c2;  z-index:2;
                border-radius:10px; -webkit-border-radius:10px; -moz-border-radius:10px; -ms-border-radius:10px;-o-border-radius:10px;background-color: rgba(255,255,255,0.8);}
            ...
            .yanzheng{width:400px; height:40px;line-height:40px; margin:0 auto; margin-top:15px;vertical-align:middle;}
			.yanzheng>span{width:60px;height:40px;line-height:40px;float:left;}
			.yanzheng>input{float:left;}
			.yanzheng>img{float:left;margin-left:10px;margin-right:5px;}
            ...
            .shuru{width:88%; height:40px; padding-left:6px; float:right; border:1px solid #c2c2c2;
                border-radius:5px; -webkit-border-radius:5px; -moz-border-radius:5px; -ms-border-radius:5px;-o-border-radius:5px;}
            .yan{width:20%; margin-left:10%; margin-top:2%; float:left;width: 131px;height: 23px;border: 1px solid #333;}
            .shuzi{width:30%; margin-top:2%; float:left;}
            .tj{margin-left:10%; float:left; cursor:pointer; background-color:#4bb9da;background-image: linear-gradient(to bottom, #5bc0de 0px, #2aabd2 100%);background-repeat: repeat-x; border-color: #28a4c9;
			...
			#captcha{height:40px;display:inline;}
			@media screen and (max-width:1920px){
            .beijing{width:1000px; margin:0 auto; position:relative; z-index:0;}
			.beijing img{width:100%; position:relative; z-index:1;}
            .denglu{width:500px; height:250px; position:absolute; border:1px solid #c2c2c2;  z-index:2;
                border-radius:10px; -webkit-border-radius:10px; -moz-border-radius:10px; -ms-border-radius:10px;-o-border-radius:10px;background-color: rgba(255,255,255,0.8);}
            .username{width:400px; height:40px; line-height:40px; margin:0 auto; margin-top:50px;;}
            .password{width:400px; height:40px; line-height:40px; margin:0 auto; margin-top:15px;}
...
<div class="beijing"><!--此处可以用行间样式加背景图，背景图长宽比例最好是跟屏幕大小一致-->
	<img id="im" src="/Public/images/beijing.jpg">
    <div class="denglu">
        <form method="post" action="<?php echo U('login/loginDo');?>" name="form" id="form">
            ...
            <div class="yanzheng">
                    ...
                    <img id="captchaimg" src="<?php echo U('Login/showVerify');?>" style="width:60px;height:40px;vertical-align:middle;">
