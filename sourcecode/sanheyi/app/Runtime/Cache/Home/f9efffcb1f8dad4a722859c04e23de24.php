...
<head>
    ...
    <style type="text/css">
        @media screen and (max-width:1920px){
            ...
            .denglu{width:500px; height:250px; position:absolute;top:100px; left: 100px; border:1px solid #c2c2c2;  z-index:2;
    ...
    <div class="denglu">
        <form method="post" action="<?php echo U('login/loginDo');?>" name="form" id="form">
            ...
            <div class="yanzheng">
                    ...
                    <img id="captchaimg" src="<?php echo U('Login/showVerify');?>" style="width:60px;height:40px">
