        ...
        <ul class="er">
            <form method="post" action="<?php echo U('uc/sendSZZDo');?>" name="form" id="form">
                ...
                <li>
                    ...
                    <div class="nei2"><input type="text" id="name" name="name" class="inp1" /><span class="xin">*</span><span class="tishi m_family_name">无此用户</span></div>
        ...
        $.ajax({
            ...
            success : function(data){
                ...
                if(data.result=='SUCCESS'){
                    ...
                    $('.m_family_name').text( data.return_data.family_name);
                    $('#to_user_id').val(data.return_data.p_id);//获得该接收人的id
                }else{
                    $('.m_family_name').text('无此用户');
                    alert(data.msg);
                }
